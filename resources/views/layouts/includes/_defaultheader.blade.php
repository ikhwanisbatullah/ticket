                        ...
                        <li class="currency-menu"><a href="#"><span class="icon_lock_alt"></span></a>
                            ...
                            <ul class="currency-dropdown">
                              ...
                              <li><a href="#">language</a>
                                  <ul>
                                      <li class="active"><a href="#"><img src="/public/img/icon/en-gb.png" alt="">English</a></li>
                                      <li><a href="#"><img src="/public/img/icon/de-de.png" alt="">French</a></li>
                                  </ul>
                              </li>
                            ...
                            <div class="header-cart">
                              <ul class="cart-items">
                                  <li class="single-cart-item">
                                      <div class="cart-img">
                                          <a href="cart.html"><img src="/public/img/cart/cart1.jpg" alt=""></a>
                                      </div>
                                  ...
                                  <li class="single-cart-item">
                                      <div class="cart-img">
                                          <a href="cart.html"><img src="/public/img/cart/cart2.jpg" alt=""></a>
                                      </div>
                                      <div class="cart-content">
